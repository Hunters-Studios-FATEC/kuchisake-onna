...
public class Cutscene2 implements Screen {
    ...
    public Cutscene2(TerrorGame terrorGame) {
        ...
        textureAtlas = terrorGame.getAssetManager().get("Cutscenes/Cutscene2Objects.atlas");
        ...
        textActor = new TextActor(terrorGame, viewport.getWorldWidth() / 2, viewport.getWorldHeight() / 2, cutsceneTheme, false);
